package jv.microbenchmark.runner.collections;

import jv.microbenchmark.TFiDFExecutionPlan;
import jv.records.Data;
import jv.tfidf.collections.threads.ConsumerThreadDF;
import jv.tfidf.collections.threads.ConsumerThreadTFiDF;
...
public class ConcurrentCollectionsRunner {
    ...
    public void compute_df(TFiDFExecutionPlan plan, Blackhole blackhole) {
        ...
        final LinkedBlockingQueue<String> buffer = new LinkedBlockingQueue<>(plan.buffer_size);
